...
// 6. RISULTATO E INVIO A GOOGLE MODULI
function mostraRisultato() {
    ...
    dati.append("entry.880556117", nomeStudente); // IL TUO ENTRY PER IL NOME
    dati.append("entry.1119565011", punti + "/" + domande.length); // IL TUO ENTRY PER IL VOTO
    ...
    app.innerHTML = `
        <div style="text-align: center; padding: 50px;">
            ...
            <p>Il risultato è stato inviato al professore.</p>
